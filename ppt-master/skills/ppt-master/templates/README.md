...
| `中国银行` | Brand | 高端咨询、工作汇报、产品宣讲、经营分析、战略沟通、管理层汇报、国有银行内部沟通 | `#A50021` | 稳健、权威、克制、金融可信、国有大行品牌感；以中国银行红、官方标识、浅灰秩序线、留白和品牌背景图建立庄重专业气质。 |
...
| `中国银行` | Bank of China executive reporting style, restrained red-gold brand identity for consulting-grade briefings to state-owned bank leadership |
